<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active" data-bs-toggle="tab" href="#laboratuvar"
            >Laboratuvar</a
        >
    </li>
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#patoloji">Patoloji</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#radyoloji">Radyoloji</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#belge"
            >Belge Doğrulama</a
        >
    </li>
</ul>
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade active show" id="laboratuvar">
        <p>
    ...
    <div class="tab-pane fade" id="patoloji">
        <p>
    ...
    <div class="tab-pane fade" id="radyoloji">
        <p>
    ...
    <div class="tab-pane fade" id="belge">
        <p>
